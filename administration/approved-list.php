...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Course wide applicants</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Program Wise Approved List(All)</h5>

                    <!-- Custom Styled Validation -->
                    <form class="row g-3 needs-validation" method="post" action="list-approved-applicants.php">
                        ...
                        <div class="col-12 mx-auto">
                            <button class="btn btn-primary" name="generate_approve_list" type="submit">Export</button>
                        </div>
                    </form>
