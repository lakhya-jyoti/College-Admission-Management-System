                ...
                <div class="card">
                    <div class="card-body table-responsive-sm">
                        ...
                        <table class="table datatable table-hover" style="font-size: 14px;">
                            ...
                            <tbody>
                                <?php
                                $select = "SELECT * FROM `applicants`where user_status !='Admin'  order by std_f_name asc";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="show_std_details.php?id=<?= $fetch_applicants['applicants_id'] ?>" class="btn btn-primary my-2" name="applicants_edit"><i class="bi bi-eye"></i></a>
                                            <form action="<?= $web_socket ?>includes/action.php" method="post">
                                                ...
                                                <button class="btn btn-danger" onclick="return confirm('Are you sure?')" name="delete_applicants"><i class="bi bi-trash"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                <?php
